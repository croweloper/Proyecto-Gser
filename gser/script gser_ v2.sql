...
START TRANSACTION;
USE `gser_db`;
INSERT INTO `gser_db`.`categoria_servicio` (`catser_cod`, `catser_decripcion`, `catser_estado`) VALUES (1, 'Enseñanza', 1);
INSERT INTO `gser_db`.`categoria_servicio` (`catser_cod`, `catser_decripcion`, `catser_estado`) VALUES (2, 'Mantenimiento', 1);
INSERT INTO `gser_db`.`categoria_servicio` (`catser_cod`, `catser_decripcion`, `catser_estado`) VALUES (3, 'Recreacion y Ocio', 1);
INSERT INTO `gser_db`.`categoria_servicio` (`catser_cod`, `catser_decripcion`, `catser_estado`) VALUES (4, 'Viajes y Turismo', 1);
